...
The project is to revamp the existing backend system for an e-commerce website by decomposing a monolithic API into multiple micro services including Question & Answers.
